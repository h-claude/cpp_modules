...
/*   Updated: 2024/11/04 17:48:12 by hclaude          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::~ClapTrap()
{
	std::cout << _name << " has been destroyeeeeed." << std::endl;
}
...
void	ClapTrap::attack(const std::string& target)
{
	...
	if (isDead(*this))
	{
		std::cout << "Im dead, I cant attack!" << std::endl;
		return;	
	}
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	if (isDead(*this))
	{
		std::cout << "STOP BEAT ME, IM ALREADY DEAD!!!!" << std::endl;
		return;
	}
	if (amount == 0)
	{
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	if (isDead(*this))
	{
		std::cout << "Im dead, I cant repair myself!" << std::endl;
		return;
	}
	if (!enoughEnergy(*this))
		return;
